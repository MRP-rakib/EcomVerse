    ...
    return (
        <div className='text-[16px] cursor-pointer font-medium'>
            <div className='relative group flex  rounded-[4px] overflow-hidden justify-center items-center h-[250px] bg-[#F5F5F5]'>
                <img className='w-full h-full object-fill' src={product.thumbnail} alt="image" />
                ...
                <span className='absolute top-3 left-3 py-1 px-3 bg-[#DB4444] uppercase text-[#FAFAFA] text-[12px]'>{product.discountPercentage}&#37;</span>
            ...
            <div className='pt-4'>
                ...
                <span className='flex items-center gap-3 py-2'>
                    <p className='text-[12px] lg:text-[16px] font-medium text-[#DB4444]'>&#36;{newPrice}</p>
                    <p className='text-[12px] lg:text-[16px] font-medium text-[rgba(0,0,0,0.5)] line-through'>&#36;{product.price}</p>
                </span>
                {location.pathname!=='/wishlist'&&<div className='flex gap-2 items-center'>
                    ...
                    <p className='text-[14px] text-[rgba(0,0,0,0.5)] font-semibold'>{product.rating}</p>
                </div>}
