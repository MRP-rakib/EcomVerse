            ...
            {product.map(product => (
                ...
                <div key={product._id} className='text-[16px] cursor-pointer font-medium'>
                    <div className='relative group flex rounder-[4px] overflow-hidden justify-center items-center h-[250px] bg-[#F5F5F5]'>
                        ...
                        <span onClick={()=>handelAddToCart(product)}  className='group-hover:bottom-0 group-hover:opacity-100 group-hover:visible absolute bottom-[10px] transition-all duration-300 opacity-0 invisible w-full py-2 text-center bg-[#000000] text-white'>
                            <p>Add To Cart</p>
                        </span>
                    ...
                    <div className='pt-4'>
                        <h4 className='text-[12px] lg:text-[16px] font-medium'>{product.title}</h4>
